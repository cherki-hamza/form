                                    ...
                                    @if (json_decode($dataTypeContent->{$row->field}))
                                        @foreach (json_decode($dataTypeContent->{$row->field}) as $file)
                                            <div style="margin-bottom: 20px;"
                                                class="row align-content-center text-center col-md-4">
                                                <img class="img-responsive"
                ...
                @php
                            ...
                            <div class="row">
                                <div class="form-group my-3 col-md-12 ">
                                    ...
                                    <label style="margin-left: 20px" class="control-label" for="name">Products:</label>
                                    ...
                                    <div class="list-group">
                                        <ul style="list-style: none" class="list-group-item">
                                            ...
                                            <li class="list-group-item list-group-item-secondary panel-title">
